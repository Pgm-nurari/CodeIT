...
int main() {
    ...
    do {
        ...
        switch(ch) {
            ...
            case 2: printf("Enter value: "); scanf("%d",&val); search(val); break;
            case 3: countNodes(); break;
            case 4: displayAlternate(); break;
            case 5: displayEvenPos(); break;
            ...
            case 11: printf("Enter two values and new value: "); scanf("%d%d%d",&v1,&v2,&val); insertBetween(v1,v2,val); break;
            case 12: printf("Enter position and value: "); scanf("%d%d",&pos,&val); insertAtPos(pos,val); break;
            ...
            case 17: printf("Enter position: "); scanf("%d",&pos); deleteAtPos(pos); break;
            case 18: reverse(); break;
        }
    } while(ch!=0);
    return 0;
}
